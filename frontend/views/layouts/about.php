...
<div class="page-bottom">
	<div class="wrapper-bottom-content">
		<div class="copywrite">
			<div class="contacts-copywrite-text">© leadcode <?= \frontend\widgets\SiteYears::widget(['start_year' => 2019]) ?>. все права защищены</div>
		</div>
	</div>
</div>
...
<div class="lb">
	...
	<div class="wrapper-menu-brand"><a href="/" class="nav-brand w-nav-brand"><img src="images/5d5ab4a44a2e8607b9b6560c_logo-leadcode-02.svg" alt="" class="nav-logo"></a></div>
</div>
<script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.4.1.min.220afd743d.js" type="text/javascript" integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=" crossorigin="anonymous"></script>
<script src="js/script.js?ver=1569939160" type="text/javascript"></script>
